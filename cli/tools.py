...
class ToolManager:
    ...
    async def get_all_tools(cls, clients: dict[str, MCPClient]) -> list[Tool]:
        ...
        for client_name, client in clients.items():
            # Skip clients that don't have list_tools method (like Discord bot)
            ...
            try:
                ...
                print(f"Error getting tools from client {client_name}: {e}")
        return tools
    ...
    async def _find_client_with_tool(
        ...
        for client in clients:
            ...
            try:
                ...
                print(f"Error checking tools for client: {e}")
        return None
